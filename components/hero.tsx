...
export function Hero() {
  ...
  return (
 <section className="relative h-screen overflow-hidden pt-32 pb-24 md:pt-44 md:pb-32">
  ...
  <div ref={ref} className="relative z-10 mx-auto max-w-6xl px-6 flex flex-col justify-center h-full">
